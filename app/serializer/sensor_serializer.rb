class SensorSerializer < ActiveModel::Serializer
  embed :ids
  attributes :custom_id, :x_orientation, :y_orientation, :z_orientation, :battery_state, :battery_capacity, :manufacturer, :model, :serial_number, :firmware_version, :manufacture_date, :purchase_date, :warranty_date, :deployment_date, :last_state_change, :energy_consumption, :precision, :measurement_node_id
